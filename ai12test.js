...
// ... (Phần code buildCorpusFromDOM không thay đổi) ...
    try{
...
// ... (Phần code restoreCorpus không thay đổi) ...
    try{
...
// ... (Phần code retrieveBestAnswer không thay đổi) ...
...
// ... (Phần code loadSession không thay đổi) ...
    try{
...
// ... (Phần code detectNameFromText không thay đổi) ...
    if(!txt) return null;
...
// ... (Phần code addMessage không thay đổi) ...
...
// ... (Phần code showTypingDots không thay đổi) ...
...
// ... (Phần code buildSuggestions không thay đổi) ...
  ...
  /* ---------- Open/close logic ---------- */
  function openChat(){
// ... (Phần code openChat không thay đổi) ...
    if(isOpen) return;
  ...
  function closeChat(){
// ... (Phần code closeChat không thay đổi) ...
    if(!isOpen) return;
...
// ... (Phần code renderSession không thay đổi) ...
    bodyEl.innerHTML = '';
...
// ... (Phần code sendQuery không thay đổi) ...
...
// ... (Phần code avoidOverlap không thay đổi) ...
    try{
      const rootEl = root;
...
// ... (Phần code attachViewportHandler không thay đổi) ...
...
// ... (Phần code adaptCardHeight không thay đổi) ...
    try{
