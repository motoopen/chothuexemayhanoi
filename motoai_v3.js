// MotoAI v3.2 by Motoopen 😎
// FIXED: Không tự thu khung chat khi bấm gửi hoặc gõ chữ (iPhone/Safari bug)
window.addEventListener("DOMContentLoaded", () => {
  ...
  .m-msg { margin:6px 0; padding:10px 12px;
  ...
  const state = { msgs: [{ role:'bot', text:'Chào bạn 👋! Mình là MotoAI v3.2 — hỏi thử điều gì đó nhé.' }] };
  ...
  // ⚙️ Ngăn chặn backdrop tự đóng khi bấm vào input hoặc gửi
  ...
  render();
  console.log("✅ MotoAI v3.2 Loaded & fixed Safari click bug!");
});
